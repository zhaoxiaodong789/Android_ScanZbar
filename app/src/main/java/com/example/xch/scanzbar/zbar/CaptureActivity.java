...
import com.example.xch.scanzbar.zbar.camera.CameraManager;
import com.example.xch.scanzbar.zbar.decode.MainHandler;
import com.example.xch.scanzbar.zbar.utils.BeepManager;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        if (holder == null) {
            Log.e(TAG, "*** 没有添加SurfaceHolder的CallsHasSurface = true;back");
        }
        if (isOpenCamera) {
            if (!isHasSurface) {
